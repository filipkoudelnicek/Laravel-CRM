        ...
        <form method="POST" action="{{ route('projects.store') }}">
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="number" step="0.01" min="0" name="estimated_cost" value="{{ old('estimated_cost') }}" class="form-control" placeholder="0.00">
            </div>
            <div class="col-md-6 mb-3">
              <label class="form-label">Hodinová sazba (Kč)</label>
              <input type="number" step="0.01" min="0" name="hourly_rate" value="{{ old('hourly_rate') }}" class="form-control" placeholder="0.00">
            </div>
          </div>
          <div class="d-flex justify-content-end gap-2">
            <a href="{{ route('projects.index') }}" class="btn btn-outline-secondary btn-sm">Zrušit</a>
            <button type="submit" class="btn bg-gradient-primary btn-sm">Vytvořit projekt</button>
          </div>
        </form>
      </div>
    </div>
